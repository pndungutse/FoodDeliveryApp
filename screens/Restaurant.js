                    ...
                    restaurant?.menu.map((item, index) => (
                        ...
                        >
                            <View style={{height: SIZES.height * 0.35}}>
                                ...
                                <View style={{
                                    ...
                                    >
                                        ...
                                        <Text style={{
                                            ...FONTS.body1,
                                            color: getOrderQty(item.menuId) == 0 ? COLORS.darkgray : COLORS.black
                                            }}>-</Text>
                                    </TouchableOpacity>
                            ...
                            <View style={{
                                ...
                                <Text style={{marginVertical:10, alignItems: 'center', ...FONTS.h2}}> 
